...
export default function LoginPage() {
  ...
  return (
    <div className="relative overflow-hidden bg-[#0d0114]">
      ...
      <div className="container-page relative z-10 flex min-h-[calc(100vh-64px)] items-center justify-center py-16">
        <div className="w-full max-w-md">
          <div className="mb-6 text-center">
            <p className="font-mono text-sm font-medium text-[#f0822b]">Student Login</p>
            <h1 className="mt-2 font-display text-2xl font-semibold text-white">
              Log in to your dashboard
            </h1>
            <p className="mt-2 text-sm text-slate-300">
              Use the Student ID and password Lavanya gave you.
            </p>
          </div>
          ...
          <p className="mt-5 text-center text-sm text-slate-300">
            ...
            <a
              ...
              className="font-medium text-[#f0822b] hover:underline"
            >
              Message Lavanya on WhatsApp
            </a>
          </p>
          <p className="mt-2 text-center text-xs text-slate-400">
            Are you Lavanya?{" "}
            <Link href="/admin/login" className="text-slate-300 hover:text-[#f0822b]">
              Admin login
            </Link>
          </p>
        </div>
